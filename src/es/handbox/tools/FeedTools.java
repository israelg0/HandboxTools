...
public class FeedTools  {
            ...
            try {
                if (sentido!=null)
                {
                    ...
                    respuesta.setMensaje("Sincronizacion en curso");
                     ...
                     respuesta.setMensaje("Par�metros incorrectos, necesarios sentido y limite ");
                 }
    ...
    public String numBloggers(@QueryParam("entorno") String entorno) {
        ...
        if (entorno!=null)
        {
           ...
           respuesta.setMensaje("Respuesta:"+resultado);
             ...
             respuesta.setCodigo("701");
             respuesta.setMensaje("Par�metros incorrectos, necesario entorno ");
         }
        Gson gson = new Gson();
        return gson.toJson(respuesta);
    }
    ...
    public String bloggersSinFeed(@QueryParam("entorno") String entorno) {
        ...
        if (!res.isBloqueado())
        {
            ...
            respuesta.setCodigo("601");
            respuesta.setMensaje("Ya se est� ejecutando alg�n proceso. Por favor, espera unos minutos para volver a intentarlo");
        }
    ...
    public String sincronizarEntradas(@QueryParam("sentido") String sentido, @QueryParam("limite") String limite) {
        ...
        if (!res.isBloqueado())
        {
            ...
            if ((sentido!=null)&&(limite!=null))
            {
                ...
                respuesta.setCodigo("200");
                respuesta.setMensaje("Sincronizaci�n en curso");
                res.desbloquear();
            }else{
                 respuesta.setCodigo("701");
                 respuesta.setMensaje("Par�metros incorrectos, necesarios sentido y limite ");
    ...
    public String categorizarEntrada(@QueryParam("entorno") String entorno, @QueryParam("identrada") String identrada) {
        ...
        if (!res.isBloqueado())
        {
            ...
            if ((entorno!=null)&&(identrada!=null))
            {
                ...
                respuesta.setCodigo("200");
                respuesta.setMensaje("Categorizaci�n en curso");
                res.desbloquear();
            }else{
                 respuesta.setCodigo("701");
                 respuesta.setMensaje("Par�metros incorrectos, necesarios entorno y identrada");
             }
        }else {
            respuesta.setCodigo("601");
            respuesta.setMensaje("Ya se est� ejecutando alg�n proceso. Por favor, espera unos minutos para volver a intentarlo");
        ...
        if (!res.isBloqueado())
        {
            if ((entorno!=null)&&(identrada!=null)&&(limite!=null))
            {
                ...
                res.desbloquear();
                 ...
                 respuesta.setCodigo("701");
                 respuesta.setMensaje("Par�metros incorrectos, necesarios entorno, identrada y limite");
             }
        }else {
            respuesta.setCodigo("601");
            respuesta.setMensaje("Ya se est� ejecutando alg�n proceso. Por favor, espera unos minutos para volver a intentarlo");
